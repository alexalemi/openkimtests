...
class FCCElasticConstants(BaseTest):
    """Determine the cubic elastic constants by numerically determining the Hessian"""

    def __init__(self,*args,**kwargs):
	super(FCCElasticConstants,self).__init__(*args,**kwargs)
...
if __name__ == '__main__':
    test = FCCElasticConstants(args.potential,args.element,write=args.write)
